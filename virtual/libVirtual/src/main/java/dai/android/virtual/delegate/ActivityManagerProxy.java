...
public class ActivityManagerProxy implements InvocationHandler {
    ...
    private Object bindService(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        Plugin.putBinder(bundle, "sc", (IBinder) args[4]);
        startDelegateServiceForTarget(target,
    ...
    private Intent wrapperTargetIntent(Intent target,
                                       ServiceInfo serviceInfo,
                                       Bundle extras,
                                       int command) {
        ...
        boolean local = Plugin.isLocalService(serviceInfo);
    ...
    private void getIntentSender(Method method, Object[] args) {
        ...
        if (intentSenderType == INTENT_SENDER_ACTIVITY) {
            ...
            if (resolveInfo != null && resolveInfo.serviceInfo != null) {
                // find plugin service
                Intent wrapperIntent = wrapperTargetIntent(
                        target,
                        resolveInfo.serviceInfo,
                        null,
