...
import dai.android.virtual.aapt.Aapt
import dai.android.virtual.collector.ResourceCollector
...
class ProcessResourcesHooker extends GradleTaskHooker<ProcessAndroidResources> {
    ...
    void afterTaskExecute(ProcessAndroidResources par) {
         ...
         */
        dai.android.virtual.utils.ZipUtil.with(apFile).deleteAll(filteredResources + updatedResources)
