...
import dai.android.virtual.hooker.TaskHookerManager
import dai.android.virtual.transform.StripClassAndResTransform


import dai.android.virtual.utils.FileBinaryCategory
...
class VAPlugin extends BasePlugin {
    ...
    private void checkConfig() {
        ...
        if (hostR.exists()) {
            ...
            err.append("  need apply dai.android.virtual.host in build.gradle of host application\n ")
            throw new InvalidUserDataException(err.toString())
        }
